...
Progress to the link:https://github.com/vert-x3/vertx-examples/blob/master/maven-verticle[simple Maven verticle example] 
to show you how to deploy your code as verticles in
a Maven project.
